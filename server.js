...
function buildFakeEnvSnapshot() {
    return [
        ...
        'DB_PASSWORD=R3pl1ca!Archive!2026',
        'REDIS_URL=redis://cache-repl.internal:6379/2',
        'AWS_ACCESS_KEY_ID=AKIATROLLMIRROR26',
        'AWS_SECRET_ACCESS_KEY=troll-only-fake-secret-value',
        'JWT_SECRET=legacy-honeypot-signing-key',
